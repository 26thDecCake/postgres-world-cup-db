...
--
-- Name: games_game_id_seq1; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.games_game_id_seq1 OWNER TO freecodecamp;

--
-- Name: games_game_id_seq1; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--
...
--
-- Name: games_game_id_seq1; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.games_game_id_seq1', 32, true);
...
SELECT pg_catalog.setval('public.teams_team_id_seq1', 24, true);
